...
inline std::vector<float> fit_shape_to_landmarks_linear(
    ...
    std::experimental::optional<float> detector_standard_deviation = std::experimental::optional<float>(),
    std::experimental::optional<float> model_standard_deviation = std::experimental::optional<float>())
{
