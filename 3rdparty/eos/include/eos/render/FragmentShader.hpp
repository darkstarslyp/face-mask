...
public:
    ...
    glm::tvec4<T, P> shade_triangle_pixel(int x, int y, const detail::Vertex<T, P>& point_a,
                                          ...
                                          const std::experimental::optional<Texture>& texture, float dudx, float dudy,
...
public:
    ...
    glm::tvec4<T, P> shade_triangle_pixel(int x, int y, const detail::Vertex<T, P>& point_a,
                                          const detail::Vertex<T, P>& point_b,
                                          const detail::Vertex<T, P>& point_c, const glm::tvec3<T, P>& lambda,
                                          const std::experimental::optional<eos::render::Texture>& texture, float dudx,
...
public:
    ...
    glm::tvec4<T, P> shade_triangle_pixel(int x, int y, const detail::Vertex<T, P>& point_a,
                                          const detail::Vertex<T, P>& point_b,
                                          const detail::Vertex<T, P>& point_c, const glm::tvec3<T, P>& lambda,
                                          const stdt::experimental::optional<Texture>& texture, float dudx, float dudy,
                                          float dvdx, float dvdy)
    {
